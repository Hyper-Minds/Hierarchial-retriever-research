...
def store_coarse_chunks():
    ...
    if(os.path.exists(COARSE_CHUNKS_2025_FOLDER) == False):
        os.makedirs(COARSE_CHUNKS_2025_FOLDER)
    ...
    for idx, row in df.iterrows():
        ...
        CHUNK_OUTPUT_DIR = os.path.join(COARSE_CHUNKS_2025_FOLDER, document_id)

        chunk_lists = hybrid_chunk_document(document_id, document_text, CHUNK_OUTPUT_DIR)
